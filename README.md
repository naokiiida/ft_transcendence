...
ft\_transcendence is a multi-user web application centered around a real-time competitive Pong game. Built with Next.js + NestJS, it supports local matches, AI matches, and online matchmaking.
...
- [ft\_transcendence Guide (Zenn)](https://zenn.dev/mfunyu/books/ft_transcendence)
